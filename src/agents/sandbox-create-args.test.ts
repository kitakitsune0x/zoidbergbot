...
describe("buildSandboxCreateArgs", () => {
  it("includes hardening and resource flags", () => {
    ...
    const args = buildSandboxCreateArgs({
      name: "zoidbergbot-sbx-test",
      cfg,
      scopeKey: "main",
      createdAtMs: 1700000000000,
      labels: { "zoidbergbot.sandboxBrowser": "1" },
    });
    ...
    expect(args).toEqual(
      expect.arrayContaining([
        "create",
        "--name",
        "zoidbergbot-sbx-test",
        "--label",
        "zoidbergbot.sandbox=1",
        "--label",
        "zoidbergbot.sessionKey=main",
        "--label",
        "zoidbergbot.createdAtMs=1700000000000",
        "--label",
        "zoidbergbot.sandboxBrowser=1",
        "--read-only",
        "--tmpfs",
        "/tmp",
        "--network",
