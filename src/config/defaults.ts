import type { ZoidbergBotConfig } from "./types.js";
...
function resolveAnthropicDefaultAuthMode(cfg: ZoidbergBotConfig): AnthropicAuthDefaultsMode | null {
...
export function applyMessageDefaults(cfg: ZoidbergBotConfig): ZoidbergBotConfig {
...
export function applyTalkApiKey(config: ZoidbergBotConfig): ZoidbergBotConfig {
...
export function applyModelDefaults(cfg: ZoidbergBotConfig): ZoidbergBotConfig {
  let mutated = false;
  let nextCfg = cfg;
...
export function applyAgentDefaults(cfg: ZoidbergBotConfig): ZoidbergBotConfig {
...
export function applyLoggingDefaults(cfg: ZoidbergBotConfig): ZoidbergBotConfig {
...
export function applyContextPruningDefaults(cfg: ZoidbergBotConfig): ZoidbergBotConfig {
...
export function applyCompactionDefaults(cfg: ZoidbergBotConfig): ZoidbergBotConfig {
  const defaults = cfg.agents?.defaults;
  if (!defaults) {
    return cfg;
  }
