...
function listConfiguredAccountIds(cfg: ZoidbergBotConfig): string[] {
...
export function listWhatsAppAuthDirs(cfg: ZoidbergBotConfig): string[] {
...
export function hasAnyWhatsAppAuth(cfg: ZoidbergBotConfig): boolean {
  return listWhatsAppAuthDirs(cfg).some((authDir) => hasWebCredsSync(authDir));
}

export function listWhatsAppAccountIds(cfg: ZoidbergBotConfig): string[] {
...
export function resolveDefaultWhatsAppAccountId(cfg: ZoidbergBotConfig): string {
...
export function resolveWhatsAppAuthDir(params: { cfg: ZoidbergBotConfig; accountId: string }): {
  authDir: string;
  isLegacy: boolean;
} {
...
export function listEnabledWhatsAppAccounts(cfg: ZoidbergBotConfig): ResolvedWhatsAppAccount[] {
