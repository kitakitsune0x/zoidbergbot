...
- Version alignment with core ZoidbergBot release numbers.
...
- First public release of the @zoidbergbot/voice-call plugin.
...
- CLI: `zoidbergbot voicecall` commands (call/start/continue/speak/end/status/tail/expose).
