import type { ZoidbergBotConfig } from "zoidbergbot/plugin-sdk";
...
export function listGoogleChatAccountIds(cfg: ZoidbergBotConfig): string[] {
...
export function resolveDefaultGoogleChatAccountId(cfg: ZoidbergBotConfig): string {
...
export function listEnabledGoogleChatAccounts(cfg: ZoidbergBotConfig): ResolvedGoogleChatAccount[] {
