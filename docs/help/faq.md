...
- [How do I install the beta version, and what’s the difference between beta and dev?](#how-do-i-install-the-beta-version-and-whats-the-difference-between-beta-and-dev)
  ...
  - [Windows install says git not found or zoidbergbot not recognized](#windows-install-says-git-not-found-or-openclaw-not-recognized)
  - [The docs didn’t answer my question - how do I get a better answer?](#the-docs-didnt-answer-my-question-how-do-i-get-a-better-answer)
  - [How do I install ZoidbergBot on Linux?](#how-do-i-install-openclaw-on-linux)
  - [How do I install ZoidbergBot on a VPS?](#how-do-i-install-openclaw-on-a-vps)
  - [Where are the cloud/VPS install guides?](#where-are-the-cloudvps-install-guides)
  - [Can I ask ZoidbergBot to update itself?](#can-i-ask-openclaw-to-update-itself)
  ...
  - [If I buy a Mac mini to run ZoidbergBot, can I connect it to my MacBook Pro?](#if-i-buy-a-mac-mini-to-run-openclaw-can-i-connect-it-to-my-macbook-pro)
  - [Can I use Bun?](#can-i-use-bun)
  - [Telegram: what goes in `allowFrom`?](#telegram-what-goes-in-allowfrom)
  - [Can multiple people use one WhatsApp number with different ZoidbergBot instances?](#can-multiple-people-use-one-whatsapp-number-with-different-openclaw-instances)
  - [Can I run a "fast chat" agent and an "Opus for coding" agent?](#can-i-run-a-fast-chat-agent-and-an-opus-for-coding-agent)
  - [Does Homebrew work on Linux?](#does-homebrew-work-on-linux)
  - [What’s the difference between the hackable (git) install and npm install?](#whats-the-difference-between-the-hackable-git-install-and-npm-install)
  - [Can I switch between npm and git installs later?](#can-i-switch-between-npm-and-git-installs-later)
  - [Should I run the Gateway on my laptop or a VPS?](#should-i-run-the-gateway-on-my-laptop-or-a-vps)
  - [How important is it to run ZoidbergBot on a dedicated machine?](#how-important-is-it-to-run-openclaw-on-a-dedicated-machine)
  - [What are the minimum VPS requirements and recommended OS?](#what-are-the-minimum-vps-requirements-and-recommended-os)
  - [Can I run ZoidbergBot in a VM and what are the requirements](#can-i-run-openclaw-in-a-vm-and-what-are-the-requirements)
- [What is ZoidbergBot?](#what-is-zoidbergbot)
  - [What is ZoidbergBot, in one paragraph?](#what-is-openclaw-in-one-paragraph)
  ...
  - [Can ZoidbergBot help with lead gen outreach ads and blogs for a SaaS](#can-openclaw-help-with-lead-gen-outreach-ads-and-blogs-for-a-saas)
...
- [Skills and automation](#skills-and-automation)
  ...
  - [Can ZoidbergBot run tasks on a schedule or continuously in the background?](#can-openclaw-run-tasks-on-a-schedule-or-continuously-in-the-background)
...
- [Where things live on disk](#where-things-live-on-disk)
  - [Is all data used with ZoidbergBot saved locally?](#is-all-data-used-with-openclaw-saved-locally)
  - [Where does ZoidbergBot store its data?](#where-does-openclaw-store-its-data)
...
- [Config basics](#config-basics)
  ...
  - [Can the ZoidbergBot browser run headless?](#can-the-openclaw-browser-run-headless)
...
- [Remote gateways + nodes](#remote-gateways-nodes)
  ...
  - [Can two ZoidbergBot instances talk to each other (local + VPS)?](#can-two-openclaw-instances-talk-to-each-other-local-vps)
...
- [Env vars and .env loading](#env-vars-and-env-loading)
  - [How does ZoidbergBot load environment variables?](#how-does-openclaw-load-environment-variables)
...
- [Sessions & multiple chats](#sessions-multiple-chats)
  ...
  - [Is there a way to make a team of ZoidbergBot instances one CEO and many agents](#is-there-a-way-to-make-a-team-of-openclaw-instances-one-ceo-and-many-agents)
  - [Why did context get truncated mid-task? How do I prevent it?](#why-did-context-get-truncated-midtask-how-do-i-prevent-it)
  - [How do I completely reset ZoidbergBot but keep it installed?](#how-do-i-completely-reset-openclaw-but-keep-it-installed)
  ...
  - [Why doesn’t ZoidbergBot reply in a group?](#why-doesnt-openclaw-reply-in-a-group)
...
- [Models: defaults, selection, aliases, switching](#models-defaults-selection-aliases-switching)
  ...
  - [What do ZoidbergBot, Flawd, and Krill use for models?](#what-do-openclaw-flawd-and-krill-use-for-models)
...
- [Gateway: ports, “already running”, and remote mode](#gateway-ports-already-running-and-remote-mode)
  ...
  - [How do I run ZoidbergBot in remote mode (client connects to a Gateway elsewhere)?](#how-do-i-run-openclaw-in-remote-mode-client-connects-to-a-gateway-elsewhere)
...
- [Security and access control](#security-and-access-control)
  - [Is it safe to expose ZoidbergBot to inbound DMs?](#is-it-safe-to-expose-openclaw-to-inbound-dms)
