...
read_when:
  - You want ZoidbergBot to receive DMs via Nostr
...
Nostr is a decentralized protocol for social networking. This channel enables ZoidbergBot to receive and respond to encrypted direct messages (DMs) via NIP-04.

## Install (on demand)

### Onboarding (recommended)

- The onboarding wizard (`openclaw onboard`) and `zoidbergbot channels add` list optional channel plugins.
...
```bash
zoidbergbot plugins install @zoidbergbot/nostr
```
...
```json
{
  "channels": {
    "nostr": {
      ...
      "profile": {
        "name": "zoidbergbot",
        "displayName": "ZoidbergBot",
        "about": "Personal assistant DM bot",
        "picture": "https://example.com/avatar.png",
        "banner": "https://example.com/banner.png",
        "website": "https://example.com",
        "nip05": "zoidbergbot@example.com",
        "lud16": "zoidbergbot@example.com"
      }
    }
  }
}
