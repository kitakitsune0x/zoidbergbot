---
read_when:
  - 你想为 ZoidbergBot 选择一个聊天渠道
  - 你需要快速了解支持的消息平台
summary: ZoidbergBot 可连接的消息平台
title: 聊天渠道
x-i18n:
...
ZoidbergBot 可以在你已经使用的任何聊天应用上与你对话。每个渠道通过 Gateway网关连接。所有渠道都支持文本；媒体和回应功能因渠道而异。
...
- 渠道可以同时运行；配置多个渠道后 ZoidbergBot 会按聊天路由。
