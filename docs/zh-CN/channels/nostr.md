...
Nostr 是一个去中心化的社交网络协议。此渠道使 ZoidbergBot 能够通过 NIP-04 接收和回复加密私信（私信）。

## 安装（按需）

### 新手引导（推荐）

- 新手引导向导（`openclaw onboard`）和 `zoidbergbot channels add` 会列出可选的渠道插件。
