...
- 生成的 Swift 模型：`apps/macos/Sources/ZoidbergBotProtocol/Gateway网关Models.swift`
...
- https://raw.githubusercontent.com/zoidbergbot/zoidbergbot/main/dist/protocol.schema.json
