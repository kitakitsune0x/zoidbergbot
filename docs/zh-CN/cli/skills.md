...
summary: Skills 列表/信息/检查及 Skills 资格的 `zoidbergbot skills` CLI 参考
title: skills
x-i18n:
...
```bash
zoidbergbot skills list
zoidbergbot skills list --eligible
zoidbergbot skills info <name>
zoidbergbot skills check
```
