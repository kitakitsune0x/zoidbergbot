---
read_when:
  - 你想将 Gmail Pub/Sub 事件接入 ZoidbergBot
  - 你需要 Webhook 辅助命令
summary: "`zoidbergbot webhooks`（Webhook 辅助工具 + Gmail Pub/Sub）的 CLI 参考"
title: webhooks
x-i18n:
...
```bash
zoidbergbot webhooks gmail setup --account you@example.com
