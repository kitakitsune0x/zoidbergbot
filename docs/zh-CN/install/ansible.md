...
summary: 使用 Ansible、Tailscale VPN 和防火墙隔离进行自动化、安全加固的 ZoidbergBot 安装
title: Ansible
x-i18n:
...
# 或直接运行（之后手动执行 /tmp/zoidbergbot-setup.sh）
# ansible-playbook playbook.yml --ask-become-pass
```

## 更新 ZoidbergBot

Ansible 安装程序将 ZoidbergBot 设置为手动更新。标准更新流程详见 [更新](/install/updating)。
...
- [安全架构](https://github.com/zoidbergbot/zoidbergbot-ansible/blob/main/docs/security.md)
- [技术细节](https://github.com/zoidbergbot/zoidbergbot-ansible/blob/main/docs/architecture.md)
- [故障排除指南](https://github.com/zoidbergbot/zoidbergbot-ansible/blob/main/docs/troubleshooting.md)
