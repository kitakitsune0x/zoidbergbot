...
func NewPiTranslator(srcLang, tgtLang string, glossary []GlossaryEntry, thinking string) (*PiTranslator, error) {
	...
	options.AppName = "zoidbergbot-docs-i18n"
	options.WorkDir = "/tmp"
...
- Keep product names in English: ZoidbergBot, Pi, WhatsApp, Telegram, Discord, iMessage, Slack, Microsoft Teams, Google Chat, Signal.
- For the ZoidbergBot Gateway, use “Gateway网关”.
