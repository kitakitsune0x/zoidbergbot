...
const SKILL_SOURCE_GROUPS: Array<{ id: string; label: string; sources: string[] }> = [
  { id: "workspace", label: "Workspace Skills", sources: ["zoidbergbot-workspace"] },
  { id: "built-in", label: "Built-in Skills", sources: ["zoidbergbot-bundled"] },
  { id: "installed", label: "Installed Skills", sources: ["zoidbergbot-managed"] },
  { id: "extra", label: "Extra Skills", sources: ["zoidbergbot-extra"] },
];
