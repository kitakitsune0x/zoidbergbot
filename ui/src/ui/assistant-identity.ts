...
declare global {
  interface Window {
    __ZOIDBERGBOT_ASSISTANT_NAME__?: string;
    __ZOIDBERGBOT_ASSISTANT_AVATAR__?: string;
  }
}
...
export function resolveInjectedAssistantIdentity(): AssistantIdentity {
  ...
  return normalizeAssistantIdentity({
    name: window.__ZOIDBERGBOT_ASSISTANT_NAME__,
    avatar: window.__ZOIDBERGBOT_ASSISTANT_AVATAR__,
  });
}
