...
public actor GatewayNodeSession {
    private let logger = Logger(subsystem: "ai.zoidbergbot", category: "node.gateway")
    ...
    static func invokeWithTimeout(
        ...
        let timeoutLogger = Logger(subsystem: "ai.zoidbergbot", category: "node.gateway")
        let timeout: Int = {
    ...
    private func decodeInvokeRequest(from payload: ZoidbergBotProtocol.AnyCodable) throws -> NodeInvokeRequestPayload {
        do {
