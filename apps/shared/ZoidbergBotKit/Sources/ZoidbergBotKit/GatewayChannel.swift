...
private typealias ProtoAnyCodable = ZoidbergBotProtocol.AnyCodable
...
public actor GatewayChannelActor {
    private let logger = Logger(subsystem: "ai.zoidbergbot", category: "gateway")
