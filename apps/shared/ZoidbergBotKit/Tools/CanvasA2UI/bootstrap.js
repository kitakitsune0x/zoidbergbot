...
import "@a2ui/lit/ui";
import { themeContext } from "@zoidbergbot/a2ui-theme-context";
...
class ZoidbergBotA2UIHost extends LitElement {
  static properties = {
    surfaces: { state: true },
  ...
  connectedCallback() {
    ...
    globalThis.zoidbergbotA2UI = api;
    this.addEventListener("a2uiaction", (evt) => this.#handleA2UIAction(evt));
    this.#statusListener = (evt) => this.#handleActionStatus(evt);
    for (const eventName of ["zoidbergbot:a2ui-action-status"]) {
...
if (!customElements.get("zoidbergbot-a2ui-host")) {
  customElements.define("zoidbergbot-a2ui-host", ZoidbergBotA2UIHost);
}
