...
final class CanvasWindowController: NSWindowController, WKNavigationDelegate, NSWindowDelegate {
    ...
    init(sessionKey: String, root: URL, presentation: CanvasPresentation) throws {
        ...
        (() => {
          try {
            ...
            if (globalThis.__zoidbergbotA2UIBridgeInstalled) return;
            globalThis.__zoidbergbotA2UIBridgeInstalled = true;
            ...
            globalThis.addEventListener('a2uiaction', (evt) => {
              try {
                ...
                const handler = globalThis.webkit?.messageHandlers?.zoidbergbotCanvasA2UIAction;
                ...
                const hasBundledA2UIHost =
                  !!globalThis.zoidbergbotA2UI ||
                  !!document.querySelector('zoidbergbot-a2ui-host');
                ...
                location.href = 'zoidbergbot://agent?' + params.toString();
              } catch {}
            }, true);
          } catch {}
        })();
    ...
    func snapshot(to outPath: String?) async throws -> String {
        ...
        if let outPath, !outPath.isEmpty {
            ...
            path = "/tmp/zoidbergbot-canvas-\(CanvasWindowController.sanitizeSessionKey(self.sessionKey))-\(ts).png"
        }
