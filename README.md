...
# Send a message
zoidbergbot message send --to +1234567890 --message "Hello from ZoidbergBot"

# Talk to the assistant (optionally deliver back to any connected channel: WhatsApp/Telegram/Slack/Discord/Google Chat/Signal/iMessage/BlueBubbles/Microsoft Teams/Matrix/Zalo/Zalo Personal/WebChat)
zoidbergbot agent --message "Ship checklist" --thinking high
```

Upgrading? [Updating guide](https://docs.zoidbergbot.ai/install/updating) (and run `zoidbergbot doctor`).
...
Switch channels (git + npm): `zoidbergbot update --channel stable|beta|dev`.
Details: [Development channels](https://docs.zoidbergbot.ai/install/development-channels).
...
pnpm zoidbergbot onboard --install-daemon

# Dev loop (auto-reload on TS changes)
pnpm gateway:watch
```

Note: `pnpm zoidbergbot ...` runs TypeScript directly (via `tsx`). `pnpm build` produces `dist/` for running via Node / the packaged `zoidbergbot` binary.

## Security defaults (DM access)

ZoidbergBot connects to real messaging surfaces. Treat inbound DMs as **untrusted input**.

Full security guide: [Security](https://docs.zoidbergbot.ai/gateway/security)

Default behavior on Telegram/WhatsApp/Signal/iMessage/Microsoft Teams/Discord/Google Chat/Slack:

- **DM pairing** (`dmPolicy="pairing"` / `channels.discord.dm.policy="pairing"` / `channels.slack.dm.policy="pairing"`): unknown senders receive a short pairing code and the bot does not process their message.
- Approve with: `zoidbergbot pairing approve <channel> <code>` (then the sender is added to a local allowlist store).
- Public inbound DMs require an explicit opt-in: set `dmPolicy="open"` and include `"*"` in the channel allowlist (`allowFrom` / `channels.discord.dm.allowFrom` / `channels.slack.dm.allowFrom`).

Run `zoidbergbot doctor` to surface risky/misconfigured DM policies.

## Highlights

- **[Local-first Gateway](https://docs.zoidbergbot.ai/gateway)** — single control plane for sessions, channels, tools, and events.
- **[Multi-channel inbox](https://docs.zoidbergbot.ai/channels)** — WhatsApp, Telegram, Slack, Discord, Google Chat, Signal, iMessage, BlueBubbles, Microsoft Teams, Matrix, Zalo, Zalo Personal, WebChat, macOS, iOS/Android.
- **[Multi-agent routing](https://docs.zoidbergbot.ai/gateway/configuration)** — route inbound channels/accounts/peers to isolated agents (workspaces + per-agent sessions).
- **[Voice Wake](https://docs.zoidbergbot.ai/nodes/voicewake) + [Talk Mode](https://docs.zoidbergbot.ai/nodes/talk)** — always-on speech for macOS/iOS/Android with ElevenLabs.
- **[Live Canvas](https://docs.zoidbergbot.ai/platforms/mac/canvas)** — agent-driven visual workspace with [A2UI](https://docs.zoidbergbot.ai/platforms/mac/canvas#canvas-a2ui).
- **[First-class tools](https://docs.zoidbergbot.ai/tools)** — browser, canvas, nodes, cron, sessions, and Discord/Slack actions.
- **[Companion apps](https://docs.zoidbergbot.ai/platforms/macos)** — macOS menu bar app + iOS/Android [nodes](https://docs.zoidbergbot.ai/nodes).
- **[Onboarding](https://docs.zoidbergbot.ai/start/wizard) + [skills](https://docs.zoidbergbot.ai/tools/skills)** — wizard-driven setup with bundled/managed/workspace skills.
...
- [Gateway WS control plane](https://docs.zoidbergbot.ai/gateway) with sessions, presence, config, cron, webhooks, [Control UI](https://docs.zoidbergbot.ai/web), and [Canvas host](https://docs.zoidbergbot.ai/platforms/mac/canvas#canvas-a2ui).
- [CLI surface](https://docs.zoidbergbot.ai/tools/agent-send): gateway, agent, send, [wizard](https://docs.zoidbergbot.ai/start/wizard), and [doctor](https://docs.zoidbergbot.ai/gateway/doctor).
...
- [macOS app](https://docs.zoidbergbot.ai/platforms/macos): menu bar control plane, [Voice Wake](https://docs.zoidbergbot.ai/nodes/voicewake)/PTT, [Talk Mode](https://docs.zoidbergbot.ai/nodes/talk) overlay, [WebChat](https://docs.zoidbergbot.ai/web/webchat), debug tools, [remote gateway](https://docs.zoidbergbot.ai/gateway/remote) control.
- [iOS node](https://docs.zoidbergbot.ai/platforms/ios): [Canvas](https://docs.zoidbergbot.ai/platforms/mac/canvas), [Voice Wake](https://docs.zoidbergbot.ai/nodes/voicewake), [Talk Mode](https://docs.zoidbergbot.ai/nodes/talk), camera, screen recording, Bonjour pairing.
- [Android node](https://docs.zoidbergbot.ai/platforms/android): [Canvas](https://docs.zoidbergbot.ai/platforms/mac/canvas), [Talk Mode](https://docs.zoidbergbot.ai/nodes/talk), camera, screen recording, optional SMS.
- [macOS node mode](https://docs.zoidbergbot.ai/nodes): system.run/notify + canvas/camera exposure.

### Tools + automation

- [Browser control](https://docs.zoidbergbot.ai/tools/browser): dedicated zoidbergbot Chrome/Chromium, snapshots, actions, uploads, profiles.
- [Canvas](https://docs.zoidbergbot.ai/platforms/mac/canvas): [A2UI](https://docs.zoidbergbot.ai/platforms/mac/canvas#canvas-a2ui) push/reset, eval, snapshot.
- [Nodes](https://docs.zoidbergbot.ai/nodes): camera snap/clip, screen record, [location.get](https://docs.zoidbergbot.ai/nodes/location-command), notifications.
- [Cron + wakeups](https://docs.zoidbergbot.ai/automation/cron-jobs); [webhooks](https://docs.zoidbergbot.ai/automation/webhook); [Gmail Pub/Sub](https://docs.zoidbergbot.ai/automation/gmail-pubsub).
- [Skills platform](https://docs.zoidbergbot.ai/tools/skills): bundled, managed, and workspace skills with install gating + UI.

### Runtime + safety

- [Channel routing](https://docs.zoidbergbot.ai/concepts/channel-routing), [retry policy](https://docs.zoidbergbot.ai/concepts/retry), and [streaming/chunking](https://docs.zoidbergbot.ai/concepts/streaming).
- [Presence](https://docs.zoidbergbot.ai/concepts/presence), [typing indicators](https://docs.zoidbergbot.ai/concepts/typing-indicators), and [usage tracking](https://docs.zoidbergbot.ai/concepts/usage-tracking).
- [Models](https://docs.zoidbergbot.ai/concepts/models), [model failover](https://docs.zoidbergbot.ai/concepts/model-failover), and [session pruning](https://docs.zoidbergbot.ai/concepts/session-pruning).
- [Security](https://docs.zoidbergbot.ai/gateway/security) and [troubleshooting](https://docs.zoidbergbot.ai/channels/troubleshooting).

### Ops + packaging

- [Control UI](https://docs.zoidbergbot.ai/web) + [WebChat](https://docs.zoidbergbot.ai/web/webchat) served directly from the Gateway.
- [Tailscale Serve/Funnel](https://docs.zoidbergbot.ai/gateway/tailscale) or [SSH tunnels](https://docs.zoidbergbot.ai/gateway/remote) with token/password auth.
- [Nix mode](https://docs.zoidbergbot.ai/install/nix) for declarative config; [Docker](https://docs.zoidbergbot.ai/install/docker)-based installs.
- [Doctor](https://docs.zoidbergbot.ai/gateway/doctor) migrations, [logging](https://docs.zoidbergbot.ai/logging).
...
- **[Gateway WebSocket network](https://docs.zoidbergbot.ai/concepts/architecture)** — single WS control plane for clients, tools, and events (plus ops: [Gateway runbook](https://docs.zoidbergbot.ai/gateway)).
- **[Tailscale exposure](https://docs.zoidbergbot.ai/gateway/tailscale)** — Serve/Funnel for the Gateway dashboard + WS (remote access: [Remote](https://docs.zoidbergbot.ai/gateway/remote)).
- **[Browser control](https://docs.zoidbergbot.ai/tools/browser)** — openclaw‑managed Chrome/Chromium with CDP control.
- **[Canvas + A2UI](https://docs.zoidbergbot.ai/platforms/mac/canvas)** — agent‑driven visual workspace (A2UI host: [Canvas/A2UI](https://docs.zoidbergbot.ai/platforms/mac/canvas#canvas-a2ui)).
- **[Voice Wake](https://docs.zoidbergbot.ai/nodes/voicewake) + [Talk Mode](https://docs.zoidbergbot.ai/nodes/talk)** — always‑on speech and continuous conversation.
- **[Nodes](https://docs.zoidbergbot.ai/nodes)** — Canvas, camera snap/clip, screen record, `location.get`, notifications, plus macOS‑only `system.run`/`system.notify`.

## Tailscale access (Gateway dashboard)

ZoidbergBot can auto-configure Tailscale **Serve** (tailnet-only) or **Funnel** (public) while the Gateway stays bound to loopback. Configure `gateway.tailscale.mode`:
...
- `gateway.bind` must stay `loopback` when Serve/Funnel is enabled (ZoidbergBot enforces this).
- Serve can be forced to require a password by setting `gateway.auth.mode: "password"` or `gateway.auth.allowTailscale: false`.
- Funnel refuses to start unless `gateway.auth.mode: "password"` is set.
- Optional: `gateway.tailscale.resetOnExit` to undo Serve/Funnel on shutdown.

Details: [Tailscale guide](https://docs.zoidbergbot.ai/gateway/tailscale) · [Web surfaces](https://docs.zoidbergbot.ai/web)
...
Details: [Remote access](https://docs.zoidbergbot.ai/gateway/remote) · [Nodes](https://docs.zoidbergbot.ai/nodes) · [Security](https://docs.zoidbergbot.ai/gateway/security)
...
Details: [Nodes](https://docs.zoidbergbot.ai/nodes) · [macOS app](https://docs.zoidbergbot.ai/platforms/macos) · [Gateway protocol](https://docs.zoidbergbot.ai/concepts/architecture)
...
Details: [Session tools](https://docs.zoidbergbot.ai/concepts/session-tool)
...
### macOS (ZoidbergBot.app) (optional)
...
- Controlled via `zoidbergbot nodes …`.

Runbook: [iOS connect](https://docs.zoidbergbot.ai/platforms/ios).

### Android node (optional)

- Pairs via the same Bridge + pairing flow as iOS.
- Exposes Canvas, Camera, and Screen capture commands.
- Runbook: [Android connect](https://docs.zoidbergbot.ai/platforms/android).

## Agent workspace + skills

- Workspace root: `~/.zoidbergbot/workspace` (configurable via `agents.defaults.workspace`).
- Injected prompt files: `AGENTS.md`, `SOUL.md`, `TOOLS.md`.
- Skills: `~/.zoidbergbot/workspace/skills/<skill>/SKILL.md`.

## Configuration

Minimal `~/.zoidbergbot/zoidbergbot.json` (model + defaults):
...
[Full configuration reference (all keys + examples).](https://docs.zoidbergbot.ai/gateway/configuration)
...
Details: [Security guide](https://docs.zoidbergbot.ai/gateway/security) · [Docker + sandboxing](https://docs.zoidbergbot.ai/install/docker) · [Sandbox config](https://docs.zoidbergbot.ai/gateway/configuration)

### [WhatsApp](https://docs.zoidbergbot.ai/channels/whatsapp)

- Link the device: `pnpm zoidbergbot channels login` (stores creds in `~/.zoidbergbot/credentials`).
- Allowlist who can talk to the assistant via `channels.whatsapp.allowFrom`.
- If `channels.whatsapp.groups` is set, it becomes a group allowlist; include `"*"` to allow all.

### [Telegram](https://docs.zoidbergbot.ai/channels/telegram)
...
### [Slack](https://docs.zoidbergbot.ai/channels/slack)

- Set `SLACK_BOT_TOKEN` + `SLACK_APP_TOKEN` (or `channels.slack.botToken` + `channels.slack.appToken`).

### [Discord](https://docs.zoidbergbot.ai/channels/discord)
...
### [Signal](https://docs.zoidbergbot.ai/channels/signal)

- Requires `signal-cli` and a `channels.signal` config section.

### [iMessage](https://docs.zoidbergbot.ai/channels/imessage)

- macOS only; Messages must be signed in.
- If `channels.imessage.groups` is set, it becomes a group allowlist; include `"*"` to allow all.

### [Microsoft Teams](https://docs.zoidbergbot.ai/channels/msteams)

- Configure a Teams app + Bot Framework, then add a `msteams` config section.
- Allowlist who can talk via `msteams.allowFrom`; group access via `msteams.groupAllowFrom` or `msteams.groupPolicy: "open"`.

### [WebChat](https://docs.zoidbergbot.ai/web/webchat)
...
- [Start with the docs index for navigation and “what’s where.”](https://docs.zoidbergbot.ai)
- [Read the architecture overview for the gateway + protocol model.](https://docs.zoidbergbot.ai/concepts/architecture)
- [Use the full configuration reference when you need every key and example.](https://docs.zoidbergbot.ai/gateway/configuration)
- [Run the Gateway by the book with the operational runbook.](https://docs.zoidbergbot.ai/gateway)
- [Learn how the Control UI/Web surfaces work and how to expose them safely.](https://docs.zoidbergbot.ai/web)
- [Understand remote access over SSH tunnels or tailnets.](https://docs.zoidbergbot.ai/gateway/remote)
- [Follow the onboarding wizard flow for a guided setup.](https://docs.zoidbergbot.ai/start/wizard)
- [Wire external triggers via the webhook surface.](https://docs.zoidbergbot.ai/automation/webhook)
- [Set up Gmail Pub/Sub triggers.](https://docs.zoidbergbot.ai/automation/gmail-pubsub)
- [Learn the macOS menu bar companion details.](https://docs.zoidbergbot.ai/platforms/mac/menu-bar)
- [Platform guides: Windows (WSL2)](https://docs.zoidbergbot.ai/platforms/windows), [Linux](https://docs.zoidbergbot.ai/platforms/linux), [macOS](https://docs.zoidbergbot.ai/platforms/macos), [iOS](https://docs.zoidbergbot.ai/platforms/ios), [Android](https://docs.zoidbergbot.ai/platforms/android)
- [Debug common failures with the troubleshooting guide.](https://docs.zoidbergbot.ai/channels/troubleshooting)
- [Review security guidance before exposing anything.](https://docs.zoidbergbot.ai/gateway/security)

## Advanced docs (discovery + control)

- [Discovery + transports](https://docs.zoidbergbot.ai/gateway/discovery)
- [Bonjour/mDNS](https://docs.zoidbergbot.ai/gateway/bonjour)
- [Gateway pairing](https://docs.zoidbergbot.ai/gateway/pairing)
- [Remote gateway README](https://docs.zoidbergbot.ai/gateway/remote-gateway-readme)
- [Control UI](https://docs.zoidbergbot.ai/web/control-ui)
- [Dashboard](https://docs.zoidbergbot.ai/web/dashboard)

## Operations & troubleshooting

- [Health checks](https://docs.zoidbergbot.ai/gateway/health)
- [Gateway lock](https://docs.zoidbergbot.ai/gateway/gateway-lock)
- [Background process](https://docs.zoidbergbot.ai/gateway/background-process)
- [Browser troubleshooting (Linux)](https://docs.zoidbergbot.ai/tools/browser-linux-troubleshooting)
- [Logging](https://docs.zoidbergbot.ai/logging)

## Deep dives

- [Agent loop](https://docs.zoidbergbot.ai/concepts/agent-loop)
- [Presence](https://docs.zoidbergbot.ai/concepts/presence)
- [TypeBox schemas](https://docs.zoidbergbot.ai/concepts/typebox)
- [RPC adapters](https://docs.zoidbergbot.ai/reference/rpc)
- [Queue](https://docs.zoidbergbot.ai/concepts/queue)

## Workspace & skills

- [Skills config](https://docs.zoidbergbot.ai/tools/skills-config)
- [Default AGENTS](https://docs.zoidbergbot.ai/reference/AGENTS.default)
- [Templates: AGENTS](https://docs.zoidbergbot.ai/reference/templates/AGENTS)
- [Templates: BOOTSTRAP](https://docs.zoidbergbot.ai/reference/templates/BOOTSTRAP)
- [Templates: IDENTITY](https://docs.zoidbergbot.ai/reference/templates/IDENTITY)
- [Templates: SOUL](https://docs.zoidbergbot.ai/reference/templates/SOUL)
- [Templates: TOOLS](https://docs.zoidbergbot.ai/reference/templates/TOOLS)
- [Templates: USER](https://docs.zoidbergbot.ai/reference/templates/USER)

## Platform internals

- [macOS dev setup](https://docs.zoidbergbot.ai/platforms/mac/dev-setup)
- [macOS menu bar](https://docs.zoidbergbot.ai/platforms/mac/menu-bar)
- [macOS voice wake](https://docs.zoidbergbot.ai/platforms/mac/voicewake)
- [iOS node](https://docs.zoidbergbot.ai/platforms/ios)
- [Android node](https://docs.zoidbergbot.ai/platforms/android)
- [Windows (WSL2)](https://docs.zoidbergbot.ai/platforms/windows)
- [Linux app](https://docs.zoidbergbot.ai/platforms/linux)

## Email hooks (Gmail)

- [docs.zoidbergbot.ai/gmail-pubsub](https://docs.zoidbergbot.ai/automation/gmail-pubsub)

## Molty

ZoidbergBot was built for **Molty**, a space lobster AI assistant. 🦞
